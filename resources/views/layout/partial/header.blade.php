        ...
        <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
          <nav>
            ...
            <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
              ...
              <li class="text-sm leading-normal before:content-['/']">
                <a class="opacity-50 text-slate-700" href="javascript:;">About</a>
              </li>
              <li class="text-sm leading-normal before:content-['/']">
                <a class="opacity-50 text-slate-700" href="javascript:;">Products</a>
              </li>
              <li class="text-sm leading-normal before:content-['/']">
                <a class="opacity-50 text-slate-700" href="javascript:;">Biodata</a>
              </li>
              <li class="text-sm leading-normal before:content-['/']">
                <a class="opacity-50 text-slate-700" href="javascript:;">Guestbook</a>
              </li>
            </ol>
